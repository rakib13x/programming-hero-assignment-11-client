      ...
      <div className="flex flex-col justify-start items-start">
        ...
        <div className="mt-4 flex justify-between items-end w-full">
          <div className="flex flex-col sm:flex-row sm:space-x-4">
            <div>
              <p className="text-3xl lg:text-4xl tracking-tight font-semibold lg:leading-9 leading-7 text-red-500">
                Added Foods
              </p>
            </div>
            <div className="flex justify-start items-end mb-1 mt-2 sm:mt-0">
              <span className="text-base leading-none font-normal text-red-500">
                ({addedFoods.length})
              </span>
            </div>
          </div>
